...
«[4. Для системы №2](#4-для-системы-2)» - этот раздел содержит
...
<img
src="../images/человек-помощник/media/image1.png" width="444" />
...
- невозможно разделить “собеседник” и “system/video” по разным виртуальным входам Voicemeeter.
...
<img
src="../images/человек-помощник/media/image2.png" width="269" />
...
<img
src="../images/человек-помощник/media/image3.png" width="718" />
...
- 4.1. (Teams + Discord, no Phone Link; HW: no audio interface, 2x BT-W5)
  - 🟢 *разновидность:* (Teams + Discord, Phone Link, Default Playback = VM AUX Input; HW: no audio interface, 2x BT-W5)
...
- 4.1B. (Teams + Discord, no Phone Link; HW: no audio interface, 1x BT-W5)
  - 🟣 *разновидность:* (Teams + Discord, Phone Link, Default Playback = VM AUX Input; HW: no audio interface, 1x BT-W5)
- 4.2. (Teams + Discord; HW: audio interface, 1Mii BT, BT-W5)
  - 🔵 *разновидность:* (Teams + Discord, Phone Link, Default Playback = VM AUX Input; HW: audio interface, 1Mii BT, BT-W5)
- 4.3. (Teams + Discord; HW: audio interface, 2x BT-W5)
  - 🟡 *разновидность:* (Teams + Discord, Phone Link, Default Playback = VM AUX Input; HW: audio interface, 2x BT-W5)
...
<img
src="../images/человек-помощник/media/image4.png" width="718" />
...
<img
src="../images/человек-помощник/media/image5.png" width="718" />
...
<img
src="../images/человек-помощник/media/image6.png" width="603" />

Либо Remote = “**По умолчанию”** (с тем же результатом):

<img
src="../images/человек-помощник/media/image7.png" width="604" />
...
- **Remote/System**: автоматически через WASAPI loopback **Default
  Playback**\
  (а default playback у нас **Voicemeeter Input**, значит ShadowHint получает усиленный remote+system)
...
<img
src="../images/человек-помощник/media/image8.png" width="718" />
...
<img
src="../images/человек-помощник/media/image9.png" width="718" />
...
<img
src="../images/человек-помощник/media/image10.png" width="718" />
...
- loopback ( но конкретно в выбранном нами Arturia MiniFuse 1 эта функция есть)
- DSP-микшер
- stream-функции
- виртуальные каналы
...
- Даже гиперкардиоида не “заглушит” голоса за стеной, если они слышны в комнате (через дверь/проёмы/отражения). Она *сильнее режет* бок/тыл,
  но магии нет.
- Для максимального отсечения домашнего фона обычно дают лучший эффект:
  динамический + близкая дистанция (10–15 см) + грамотная ориентация (нулём диаграммы в сторону двери или откуда идут ненужные голоса) +
...
- Возможность крепления к пантографу, т.е. чтобы микрофон был не на настольной подставке, которая принимает на себя вибрации стола. Это
  важно, не столько по причине шумов (шумодав Krisp это всё 100% отфильтрует), скорее это важно для того, чтобы можно использовать
  вместе с ноутбуком – чтобы микрофон не мешался под руками, не пересекался с проводами, которые выходят из ноутбука, и чтобы можно
...
<img
src="../images/человек-помощник/media/image11.png" width="718" />
...
<img
src="../images/человек-помощник/media/image12.png" width="718" />
...
<img
src="../images/человек-помощник/media/image13.png" width="718" />
...
<img
src="../images/человек-помощник/media/image14.png" width="718" />
...
<img
src="../images/человек-помощник/media/image15.png" width="718" />
...
- Mic = **Voicemeeter Out B1**
- Remote = **Voicemeeter AUX Input** (получает усиленный голос собеседника Teams, см. рис. ниже)

<img
src="../images/человек-помощник/media/image16.png" width="608" />
...
<img
src="../images/человек-помощник/media/image17.png" width="529" />
...
<img
src="../images/человек-помощник/media/image18.png" width="676" />
...
<img
src="../images/человек-помощник/media/image19.png" width="718" />
...
<img
src="../images/человек-помощник/media/image20.png" width="718" />
...
<img
src="../images/человек-помощник/media/image21.png" width="718" />
...
<img
src="../images/человек-помощник/media/image22.png" width="718" />
...
<img
src="../images/человек-помощник/media/image23.png" width="718" />
...
<img
src="../images/человек-помощник/media/image24.png" width="718" />
