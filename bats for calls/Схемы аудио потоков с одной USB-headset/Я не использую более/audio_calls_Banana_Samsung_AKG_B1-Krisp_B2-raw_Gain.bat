...
start "" "C:\Program Files (x86)\VB\Voicemeeter\voicemeeterpro_x64.exe" -L"C:\Program Files (x86)\VB\VoicemeeterBanana_calls_mode_Samsung_AKG_headset_B1-Krisp_B2-raw_Gain.xml"
timeout /t 1 >nul
