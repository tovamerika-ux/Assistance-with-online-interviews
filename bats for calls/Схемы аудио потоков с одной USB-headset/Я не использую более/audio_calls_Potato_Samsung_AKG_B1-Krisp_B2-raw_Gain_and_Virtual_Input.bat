...
start "" "C:\Program Files (x86)\VB\Voicemeeter\voicemeeter8x64.exe" -L"C:\Program Files (x86)\VB\VoicemeeterPotato_calls_mode_Samsung_AKG_headset_B1-Krisp_B2-raw_Gain_and_Virtual_Input.xml"
timeout /t 1 >nul
