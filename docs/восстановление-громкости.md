...
<figure>
<img
src="../images/громкость-шумодав/media/image1.png"
style="width:5.784in;height:3.50197in" />
...
<img
src="../images/громкость-шумодав/media/image2.png"
style="width:3.5933in;height:8.01983in" />
...
<figure>
<img
src="../images/громкость-шумодав/media/image3.png"
style="width:5.408in;height:4.35572in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>
...
<figure>
<img
src="../images/громкость-шумодав/media/image4.png"
style="width:7.48056in;height:4.52569in" />
...
<figure>
<img
src="../images/громкость-шумодав/media/image5.png"
style="width:4.05206in;height:4.60305in" />
...
<figure>
<img
src="../images/громкость-шумодав/media/image6.png"
style="width:6.56835in;height:3.16283in" />
<figcaption><blockquote>
<p>Рисунок</p>
</blockquote></figcaption>
</figure>
...
<figure>
<img
src="../images/громкость-шумодав/media/image7.png"
style="width:7.48056in;height:2.232in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>
...
<figure>
<img
src="../images/громкость-шумодав/media/image8.png"
style="width:3.12143in;height:3.03472in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>
...
<figure>
<img
src="../images/громкость-шумодав/media/image9.png"
style="width:3.74312in;height:7.96503in" />
...
Схема на рис. 3 в [разделе 1.4](#прочие-кнопки-a-и-b) (назовём её
...
<figure>
<img
src="../images/громкость-шумодав/media/image10.png"
style="width:1.56631in;height:4.12257in" />
<figcaption><blockquote>
<p>Рисунок</p>
</blockquote></figcaption>
</figure>
...
схеме](#минимальная-схема)» они **не могут попасть к собеседнику**,
...
<figure>
<img
src="../images/громкость-шумодав/media/image11.png"
...
<figure>
<img
src="../images/громкость-шумодав/media/image12.png"
style="width:7.48056in;height:3.65139in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>

<figure>
<img
src="../images/громкость-шумодав/media/image13.png"
style="width:7.48056in;height:0.91458in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>
...
<figure>
<img
src="../images/громкость-шумодав/media/image14.png"
style="width:6.16761in;height:0.96362in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>
...
<figure>
<img
src="../images/громкость-шумодав/media/image15.png"
style="width:7.48056in;height:3.65764in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>
...
REM Встроенный микрофон ноута: Realtek(R) Audio\Device\Набор
микрофонов\Capture
...
REM Обычный вывод/ввод. На случай если устройства были отключены вручную
— включаем их
...
REM Завершение с /F нужно для случая, когда в настройках стоит галочка
"System Tray"
...
set
"SPK_NAME_Headset={0.0.0.00000000}.{28091505-8d38-4b96-b30c-1ffb3ba9f892}"
...
REM Звонковый вывод. На случай если устройство было отключено вручную —
включаем его
...
SoundVolumeView.exe /SetDefault "VB-Audio Voicemeeter
VAIO\Device\Voicemeeter Out B1\Capture" all
...
REM важно: Voicemeeter должен быть полностью закрыт, чтобы загрузить в
него XML-файл при следующем запуске

REM Проверка: запущен ли процесс

tasklist /FI "IMAGENAME eq voicemeeter_x64.exe" 2>NUL | find /I
"voicemeeter_x64.exe" >NUL
...
REM важно: Voicemeeter должен быть полностью закрыт, иначе XML-файл не
загрузится

start "" "C:\Program Files (x86)\VB\Voicemeeter\voicemeeter_x64.exe"
-L"C:\Program Files
(x86)\VB\Voicemeeter_calls_mode_Storm_Pro_headset.xml"
...
set
"MIC_NAME_Headset={0.0.1.00000000}.{xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx}"
...
echo Calls + Voicemeeter Storm_Pro audio profile applied. Gain: Storm
Pro output.
...
REM Гарнитура Samsung EO-IC100BWEGRU: USBC Headset\Device\Головной
телефон\\

REM Усиливаем звук от собеседника и усиливаем звук от микрофона своей
гарнитуры
...
REM Микрофон гарнитуры Samsung EO-IC100BWEGRU: USBC
Headset\Device\Головной телефон\Capture

set
"MIC_NAME_Headset={0.0.1.00000000}.{3136ddda-2336-43ab-ac93-8451214ccb99}"
...
SoundVolumeView.exe /SetDefault "VB-Audio Voicemeeter
VAIO\Device\Voicemeeter Input\Render" all
...
start "" "C:\Program Files (x86)\VB\Voicemeeter\voicemeeter_x64.exe"
-L"C:\Program Files
(x86)\VB\Voicemeeter_calls_mode_Samsung_AKG_headset_with_Virtual_Input.xml"

timeout /t 1 >nul

echo Calls + Voicemeeter Samsung_AKG audio profile applied. Gain:
1) sound from the cellphone interlocutor, 2)Samsung AKG output.
...
<figure>
<img
src="../images/громкость-шумодав/media/image16.png"
style="width:2.18125in;height:2.6386in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>
...
<figure>
<img
src="../images/громкость-шумодав/media/image17.png"
style="width:5.15017in;height:3.06849in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>

### 4.3. Настройка Voicemeeter

Используем «[минимальную схему](#минимальная-схема)», меняем только
Stereo Input 1 на “Krisp Microphone”:

<figure>
<img
src="../images/громкость-шумодав/media/image18.png"
style="width:4.79385in;height:1.81794in" />
<figcaption><p>Рисунок</p></figcaption>
</figure>
...
Телефоном»](#настройки-записи-в-windows-для-тракта-микрофон-гарнитуры-voicemeeter-связь-с-телефоном)”.
...
<img
src="../images/громкость-шумодав/media/image19.png"
style="width:5.47962in;height:2.66402in" />
...
tasklist /FI "IMAGENAME eq Krisp.exe" 2>NUL | find /I "Krisp.exe"
>NUL
