...
«[4. Для системы №2](#для-системы-2)» - этот раздел содержит описание
...
«[5.](#для-системы-2) Шумодав Krisp для входящих звуков Phone
Link/Teams» - здесь рассматриваются все доступные варианты
...
<img
src="../images/аудио-потоки/media/image1.png"
...
<img
src="../images/аудио-потоки/media/image2.png"
...
<img
src="../images/аудио-потоки/media/image3.png"
...
<img
src="../images/аудио-потоки/media/image4.png"
style="width:3.27165in;height:2.96457in" /><img
src="../images/аудио-потоки/media/image5.png"
style="width:3.28586in;height:2.97922in" />
...
3.1. (Teams ONLY; no Discord, no Phone Link; HW: no audio interface,
USB-headset)

- В этом разделе кратко рассмотрена её разновидность:

(Teams ONLY; no Discord, no Phone Link, Default
Playback = VM AUX Input; HW: no audio interface, USB-headset)

3.2. (Teams or Phone Link; no Discord; HW: no audio
interface, USB-headset)

4.1. (Teams ONLY, Discord, no Phone Link; HW: no audio interface,
USB-headset)

- В этом разделе кратко рассмотрена её разновидность:

(Teams ONLY; Discord, no Phone Link, Default
Playback = VM AUX Input; HW: no audio interface, USB-headset)

4.2. (Teams or Phone Link, Discord; HW: no audio
interface, USB-headset)
...
<img
src="../images/аудио-потоки/media/image6.png"
style="width:5.08in;height:1.33414in" />
...
<img
src="../images/аудио-потоки/media/image7.png"
style="width:6.184in;height:4.0002in" />
...
<img
src="../images/аудио-потоки/media/image8.png"
...
<img
src="../images/аудио-потоки/media/image9.png"
style="width:7.48056in;height:2.34931in" />
...
<img
src="../images/аудио-потоки/media/image12.png"
style="width:5.104in;height:4.24259in" />
...
<img
src="../images/аудио-потоки/media/image13.png"
style="width:7.48056in;height:3.35486in" />
...
<img
src="../images/аудио-потоки/media/image14.png"
style="width:7.48056in;height:2.99375in" />
...
<img
src="../images/аудио-потоки/media/image15.png"
style="width:3.96875in;height:3.85417in" />
...
<img
src="../images/аудио-потоки/media/image16.png"
style="width:7.48056in;height:4.21319in" />
...
<img
src="../images/аудио-потоки/media/image17.png"
style="width:5.43851in;height:10.33975in" />
