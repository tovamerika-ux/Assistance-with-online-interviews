...
> документа:
>
> «[3. Для системы №1](#для-системы-1)» - этот раздел содержит описание
...
>
> «[4. Для системы №2](#_4._Состав_системы)» - этот раздел содержит
...
В разделе [Задача](#задача) были уже описаны основные ветви структуры
...
USB-BT-адаптера.](#способ-без-аудио-карты-два-usb-bt-адаптера.)»:
...
один USB-BT-адаптер](#b.-способ-без-аудио-карты-один-usb-bt-адаптер.)»:
